...
export default defineConfig({
  ...
  themeConfig: {
    ...
    // },
    // footer: {
    //   message: `yang 的前端博客，欢迎 <a target="_blank" style="color: var(--vp-c-brand)" href="${github}">star ⭐</a> 让更多人发现`,
  ...
  return [
    ...
    },
    {
      ...
      items: [
        {
          text: 'YProTable组件',
          link: '/docs/vue3/YRroTable示例'
        },
        {
          text: 'YReadonlyFormItem组件',
          link: '/docs/vue3/YReadonlyFormItem示例'
        }
      ]
    },
    {
      ...
      items: [
        {
          text: 'YProTable组件',
          link: '/docs/vue3/YRroTable'
        },
        {
          text: 'YReadonlyFormItem组件',
          link: '/docs/vue3/YReadonlyFormItem'
        }
      ]
    },
    {
